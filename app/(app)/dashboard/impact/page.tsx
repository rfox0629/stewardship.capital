export default function ImpactPage() {
  return (
    <main className="dashboard-page" aria-labelledby="impact-title">
      <p className="eyebrow">Impact</p>
      <h1 id="impact-title">Impact Kingdom and community.</h1>
      <p>
        This empty shell will later organize generosity, charitable planning,
